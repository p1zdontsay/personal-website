...
const I18N = {
  en: {
    ...
    "photo.photo.lede": "Hover or tap a place to see a few frames from there &mdash; click one to view it larger. More places coming.",
  ...
  zh: {
    ...
    "photo.photo.lede": "鼠标悬停或点按一个地方即可查看那里的几张照片 &mdash; 点击某张可查看大图。之后会添加更多地方。",
