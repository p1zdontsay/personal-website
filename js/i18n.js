...
const I18N = {
  en: {
    ...
    "hero.text2": "My work spans voltage regulators and PDN designs for modern SoCs and accelerators, clock generation, digital control, and physical design. I am also interested in hardware architectures and simulators at the boundary of circuits and computation.",
  ...
  zh: {
    ...
    "hero.text2": "我的工作涵盖现代 SoC 与加速器的供电、模拟与数字计算、时钟生成、数字控制，以及 physical design。我也关注电路与计算交界处的硬件架构与仿真器。",
