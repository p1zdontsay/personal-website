...
const I18N = {
  en: {
    ...
    "photo.photo.lede": "Click a place to browse its photos &mdash; click any photo to view it larger. More places coming.",
  ...
  zh: {
    ...
    "photo.photo.lede": "点击某个地方即可浏览那里的照片 &mdash; 点击某张可查看大图。之后会添加更多地方。",
    "photo.viewall": "查看全部",
